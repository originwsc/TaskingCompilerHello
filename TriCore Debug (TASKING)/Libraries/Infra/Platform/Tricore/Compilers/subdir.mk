...
"Libraries/Infra/Platform/Tricore/Compilers/CompilerDcc.src":"../Libraries/Infra/Platform/Tricore/Compilers/CompilerDcc.c" "Libraries/Infra/Platform/Tricore/Compilers/subdir.mk"
	cctc -cs --dep-file="$*.d" --misrac-version=2012 -D__CPU__=tc33x "-fD:/Users/12/AURIX-v1.10.36-workspace/hello/TriCore Debug (TASKING)/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Wc-w508 -Ctc33x -Y0 -N0 -Z0 -o "$@" "$<"
